...
#
# # модуль, с помощью которого перемешиваем массив
#
# # пусть имеем массив всего лишь из 9 элементов
# array = [(math.factorial(100))]
...
# SELECTION SORT
array = [2, 3, 1, 4, 6, 5, 9, 8, 7]  # по возрастанию
...
print(array)
print(len(sorted(array)))

for i in range(len(array)):  # по убыванию
    idx_max = i
    for j in range(i, len(array)):
